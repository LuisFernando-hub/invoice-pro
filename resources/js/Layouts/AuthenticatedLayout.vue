                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            ...
                            <div class="relative ms-3">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('language', 'en')" method="post" as="button">{{ __('English') }}</DropdownLink>
                                        <DropdownLink :href="route('language', 'ru')" method="post" as="button">{{ __('Russian') }}</DropdownLink>
                                        <DropdownLink :href="route('language', 'ka')" method="post" as="button">{{ __('Georgian') }}</DropdownLink>
                                    </template>
                                </Dropdown>
                            </div>
